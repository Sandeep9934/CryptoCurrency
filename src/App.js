  ...
  return (
    <div className="App">
      ...
      <p className="credentials">
        By{" "}
        <a
          href="https://github.com/Sandeep9934"
          target="_blank"
          rel="noreferrer"
        >
          Sandeep Kumar Singh
        ...
        {filteredCoins.length < 1 ? (
          <div className="no-search-result">
            ...
            <p>
              ...
              keeps record of the top 200 cryptocurrencies
            </p>
          </div>
        ) : (
      ...
      <footer>
        For more amazing projects, you can visit my Github Profile at{" "}
        <a
          href="https://github.com/Sandeep9934"
          target="_blank"
          rel="noreferrer"
        >
          github.com/Sandeep Kumar Singh
        </a>
      </footer>
    </div>
  );
